...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6262588960:AAF_WenBIa-MGQteduvWlMzWMnBiLLncCSg"
else:
    tgkey = tgenv
print(tgenv)
...
def start(bot, update):
    ...
    if tim == 1:
        ...
        cache = None
        qcache = None
        botname = 'Free Chat Gpt'
        username = 'Chat_gptv1bot'
